  ...
  return (
    <div className="flex flex-col justify-center flex-grow text-center text-sm md:mt-12 animate-fadeInUp mb-16">
      ...
      <div className="text-left mx-[5vw] md:mx-[20vw] mt-5 space-y-5">
        ...
        <p className="text-[0.85rem] md:text-sm font-medium leading-[1.9] md:leading-relaxed text-[#8994AE]">
          In 2019, I was already freestyling in web design, dropping hits back to back. Initially, I designed websites with WordPress and any <Link to={"/skill"} className="text-[#1DA1F2] hover:underline">technologies</Link> I could get my hands on, both as a hobby and for various campus events at my university.
        </p>
        ...
        <p className="text-[0.85rem] md:text-sm font-medium leading-[1.9] md:leading-relaxed text-[#8994AE]">
          However, it wasn&apos;t until shortly before I graduated from university with my mechanical engineering degree in 2021 that I truly discovered my potential and decided to turn my passion for web <Link to={"/skill"} className="text-[#1DA1F2] hover:underline">technologies</Link> into a profession.
        </p>
